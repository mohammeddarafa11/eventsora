...
import {
 ...
 @Component({
                      ...
                      <div class="ed-tkt__body">
                        ...
                        <div class="ed-tkt__price">
                          @if (t.actualPrice === 0) {
                            ...
                            <span class="ed-price--amt" [style.color]="group.meta.accent">
                              {{ t.actualPrice | number:'1.0-0' }}
                            </span>
  ...
  styles: [`
    :host {
      --coral: #FF4433; --gold: #F0B429; --green: #10b981;
    ...
    .ed-meta-item__label { font-family:var(--fm); font-size:.58rem; letter-spacing:.12em; text-transform:uppercase; color:var(--muted); margin-bottom:2px; }
    .ed-meta-item__value { font-weight:600; font-size:.9rem; color:var(--text); }
    .ed-meta-item__sub   { font-size:.78rem; color:var(--muted); }
    .ed-section__title   { font-family:var(--fd); font-size:1.2rem; letter-spacing:.05em; color:var(--text); margin:0 0 .65rem; }
    ...
    .ed-panel-header {
      ...
      font-family:var(--fm); font-size:.68rem; letter-spacing:.16em; color:var(--muted);
    }
    ...
    .ed-no-tkt {
      ...
      padding:2.5rem 1rem; text-align:center; color:var(--muted); font-size:.85rem;
    }
    ...
    /* Tier row header — matches screenshot style */
    .ed-tier-row {
      display:flex; align-items:center; gap:.5rem;
      padding:.5rem .85rem; border-radius:10px; border:1px solid transparent;
      margin-bottom:.15rem;
    }
    .ed-tier-row__icon  { width:14px; height:14px; flex-shrink:0; }
    .ed-tier-row__label { font-family:var(--fm); font-size:.68rem; letter-spacing:.14em; font-weight:600; flex:1; }
    .ed-tier-row__count { font-family:var(--fm); font-size:.6rem; letter-spacing:.1em; color:var(--muted); }
    ...
    .ed-tkt:disabled  { cursor:not-allowed; }
 
    .ed-tkt__bar {
      height:3px; width:100%; opacity:0; transition:opacity .2s;
    }
    ...
    .ed-badge {
      ...
      font-family:var(--fm); font-size:.58rem; letter-spacing:.09em; border:1px solid transparent;
    }
    ...
    .ed-price--free { font-family:var(--fd); font-size:1.4rem; letter-spacing:.06em; line-height:1; }
    .ed-price--amt  { font-family:var(--fd); font-size:1.4rem; letter-spacing:.04em; line-height:1; }
    .ed-price--cur  { font-family:var(--fm); font-size:.6rem; color:var(--muted); letter-spacing:.08em; }
 
    .ed-tkt__check {
      position:absolute; top:.6rem; right:.6rem;
      width:18px; height:18px; border-radius:50%;
      display:flex; align-items:center; justify-content:center;
      color:#060608; animation:pop .22s cubic-bezier(.34,1.56,.64,1);
    }
    ...
    .ed-success {
      ...
      color:var(--green); font-size:.82rem; font-weight:500;
    }
    .ed-error-msg {
    ...
    .ed-empty__title { font-family:var(--fd); font-size:1.5rem; letter-spacing:.04em; color:var(--text); margin:0; }
 ...
 export class EventDetail implements OnInit, OnDestroy {
  ...
  /** Groups: VIP → Premium → Standard; empty tiers omitted */
  ...
  load() {
    ...
    this.route.paramMap.pipe(
      ...
      this.event.set(ev); this.loadTickets(ev.id);
    });
  }
