...
import { ZardCalendarComponent } from 'src/app/shared/components/calendar';
import type { ZardDatePickerSizeVariants } from 'src/app/shared/components/date-picker/date-picker.variants';
import { ZardIconComponent } from '@shared/components/icon/icon.component';
import { ZardPopoverComponent, ZardPopoverDirective } from 'src/app/shared/components/popover';
 ...
 */
const HEIGHT_BY_SIZE: Record<'sm' | 'default' | 'lg', string> = {
  sm: 'h-8',
  default: 'h-10',
  lg: 'h-12',
};
...
export class ZardDatePickerComponent implements ControlValueAccessor {
  ...
  readonly zType = input<'default' | 'outline' | 'ghost'>('outline');
  ...
  private onChange: (value: Date | null) => void = noopFun;
