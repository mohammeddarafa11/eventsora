...
import { ZardCalendarGridComponent } from 'src/app/shared/components/calendar/calendar-grid.component';
import { ZardCalendarNavigationComponent } from 'src/app/shared/components/calendar/calendar-navigation.component';
import type { CalendarMode, CalendarValue } from 'src/app/shared/components/calendar/calendar.types';
import {
...
} from 'src/app/shared/components/calendar/calendar.utils';
import { calendarVariants } from 'src/app/shared/components/calendar/calendar.variants';
import { mergeClasses, noopFun } from 'src/app/shared/utils/merge-classes';
...
export class ZardCalendarComponent implements ControlValueAccessor {
  ...
  private onChange: (value: CalendarValue) => void = noopFun;
  private onTouched: () => void = noopFun;
